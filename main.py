...
# SOUND
laser_sound = pygame.mixer.Sound('music.wav')
explosion_sound = pygame.mixer.Sound('low_expl.wav')
start_screen_music = pygame.mixer.Sound('epicsong.mp3')
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        if self.alive:
            ...
            self.rect.x = mouse[0] - 30
            self.rect.y = mouse[1] + 30
            
        else:
            self.alpha_duration = 0
            expl_x = self.rect.x + 30
            expl_y = self.rect.y + 30
...
class Meteor(Player):
    def __init__(self, img):
        super().__init__(img)
        self.rect.x = random.randrange(90, s_width-90)
...
class Ufo(Enemy):
    ...
    def shoot(self):
        if self.rect.x % 50 == 0:
            ...
            ufobullet.rect.x = self.rect.x + 5
...
class Game:
    ...
    def start_text(self):
        ...
        text = font.render('THE FUTURE WAR', True, 'green')
        text_rect = text.get_rect(center = (s_width/2, s_height/2))
        screen.blit(text, text_rect)

        font2 = pygame.font.SysFont('Arial', 20)
        text2 = font2.render('ProjectPython 2022', True, 'white')
        text_rect2 = text2.get_rect(center = (s_width/2, s_height/2+60))
        screen.blit(text2, text_rect2)

        
        font2 = pygame.font.SysFont('Arial', 20)
        text3 = font2.render('Pemrograman Berorientasi Pada Objek ', True, 'white')
        text_rect3 = text3.get_rect(center = (s_width/2, s_height/2+80))
        screen.blit(text3, text_rect3)


        font2 = pygame.font.SysFont('Arial', 20)
        text4 = font2.render('Project By Kelompok 1', True, 'white')
        text_rect4 = text4.get_rect(center = (s_width/2, s_height/2+100))
        screen.blit(text4, text_rect4)

        font3 = pygame.font.SysFont('Arial', 20)
        text4 = font3.render('press enter to continue game', True, 'green')
        text_rect4 = text4.get_rect(center = (s_width/2, s_height/2+150))
        screen.blit(text4, text_rect4)

        font3 = pygame.font.SysFont('Arial', 20)
        text5 = font3.render('press esc to exit game', True, 'green')
        text_rect5 = text5.get_rect(center = (s_width/2, s_height/2+170))
    ...
    def pause_text(self):
        font = pygame.font.SysFont('Arial', 50)
        text = font.render('PAUSE GAME', True, 'green')
        text_rect = text.get_rect(center = (s_width/2, s_height/2))
        screen.blit(text, text_rect)
    ...
    def game_over_text(self):
        font = pygame.font.SysFont('Arial', 50)
        text = font.render('GAME OVER AND LOSE HUMAN', True, 'green')
        text_rect = text.get_rect(center = (s_width/2, s_height/2))
        screen.blit(text, text_rect)
        
        font3 = pygame.font.SysFont('Arial', 20)
        text2 = font3.render('press esc to continue game', True, 'green')
        text_rect2 = text2.get_rect(center = (s_width/2, s_height/2+60))
        screen.blit(text2, text_rect2)
    ...
    def create_score(self):
        ...
        text_rect = text.get_rect(center=(s_width/2 + 500,s_height-700)) #(s_width-150,s_height-1000)untuk 1080p
        screen.blit(text, text_rect)
